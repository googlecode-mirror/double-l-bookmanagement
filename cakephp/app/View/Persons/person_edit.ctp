 <script>
    $(function() {
        $( "#PersonBirthday" ).datepicker({dateFormat: "yy-mm-dd", changeMonth: true, changeYear: true});
		$( "#PersonCardCreateDate" ).datepicker({dateFormat: "yy-mm-dd", changeMonth: true, changeYear: true});
		$( "#PersonCardReturnDate" ).datepicker({dateFormat: "yy-mm-dd", changeMonth: true, changeYear: true});
    });
</script>
<h1>借閱者本資料處理</h1>
	...
	<table>
		...
		<tr>
			...
			<td style='width:80px'>生日</td><td><?php echo $this->Form->text('birthday', array('readonly'=>true, 'class' => 'ref_field', 'style'=>'width:120px')); ?></td>
		</tr>
		<tr>
			<td style='width:80px'>群組</td><td colspan=5><?php echo $this->Form->select('group_id', $person_groups, array('empty'=>false)); ?></td>
		...
		<tr>
			<td style='width:80px'>發卡日期</td><td><?php echo $this->Form->text('card_create_date', array('readonly'=>true, 'class' => 'ref_field', 'style'=>'width:120px')); ?></td>
		...
		<tr>
			<td style='width:80px'>退卡日期</td><td><?php echo $this->Form->text('card_return_date', array('readonly'=>true, 'class' => 'ref_field', 'style'=>'width:120px')); ?></td>
