...
<tr id='lend_row_<?php echo $book_cnt; ?>'>
	...
	<td>
		...
		<?php echo $this->Form->hidden($book_cnt.'.s_return_date', array('value' =>date('Y-m-d', mktime(0,0,0,date('m'),date('d')+$person['Person_Level']['max_day'],date('Y'))), 'style' =>'width:90px')); ?>
	</td>
	<td>
		<?php echo $person_level[$book['Book_Instance']['level_id']]; ?>
		<?php echo $this->Form->hidden($book_cnt.'.level_id', array('value' =>$book['Book_Instance']['level_id'], 'style' =>'width:150px')); ?>
	</td>
	<td>
		<?php echo $book_status[$book['Book_Instance']['book_status']]; ?>
		<?php echo $this->Form->hidden($book_cnt.'.book_status', array('value' =>$book['Book_Instance']['book_status'], 'style' =>'width:60px')); ?>
	</td>
