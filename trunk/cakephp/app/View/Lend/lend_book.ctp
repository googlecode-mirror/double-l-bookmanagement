...
<tr id='lend_row_<?php echo $book_cnt; ?>'>
	...
	<td>
		<?php echo $book['Book_Instance']['person_level']; ?>
		<?php echo $this->Form->hidden($book_cnt.'.person_level', array('value' =>$book['Book_Instance']['person_level'], 'readonly' => true, 'style' =>'width:150px')); ?>
	</td>
	<td>
		<?php echo $book['Book_Instance']['book_status']; ?>
